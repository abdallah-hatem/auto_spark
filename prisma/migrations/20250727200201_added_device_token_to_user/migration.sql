-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('ADMIN', 'CUSTOMER', 'WASHER');
...
-- AddForeignKey
ALTER TABLE "Booking" ADD CONSTRAINT "Booking_washerId_fkey" FOREIGN KEY ("washerId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Review" ADD CONSTRAINT "Review_washerId_fkey" FOREIGN KEY ("washerId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
